...
package com.anjalimacwan.fragment;
...
import com.anjalimacwan.util.NoteListItem;
...
public class NoteListFragment extends Fragment {
    ...
    IntentFilter filter = new IntentFilter("com.anjalimacwan.LIST_NOTES");
 ...
 * implement this interface in order to receive event call backs. */
    ...
    // Returns list of filenames in /data/data/com.anjalimacwan/files/
    private static String[] getListOfNotes(File file) {
        return file.list();
    }

    // Returns an integer with number of files in /data/data/com.anjalimacwan/files/
